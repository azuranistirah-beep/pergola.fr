...
import type { PaymentMethod } from "@/repositories/payment-methods-repository";
        ...
        >
          ...
          <aside className="lg:sticky lg:top-32 lg:self-start">
            ...
            {paymentMethods.length > 0 && (
              <div className="border-border mt-6 rounded-[var(--radius-lg)] border p-6 md:p-8">
                <h3 className="font-serif text-lg">{t("paymentTitle")}</h3>
